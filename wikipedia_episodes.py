...
def main(show_season_urls):
    series = [WikipediaSeries.from_url(url) for url in show_season_urls]
    return series

async def async_main(show_season_urls):
...
if __name__ == "__main__":
    ...
    series = async_event_loop.run_until_complete(async_main(show_season_urls))
    async_event_loop.stop()

    # standard (synchronous) approach
    # series = main(show_season_urls)
